...
On my/our honor, Ayeman Maknojia and Arthur Esenaliev, this
        ...
        for node in range(len(self.vertices)):
            if node not in searched:
                ...
                while stack.is_empty() is False:
                    node_next, parent_node = stack.pop()
                    if node_next not in searched:
                        searched.append(node_next)
                        for adj in self.get_adjacent_vertices(node_next):
                            if adj in searched:
                                return True
                            else:
                                adj_info = (adj, node_next)
                                stack.push(adj_info)
